...
#ifdef AEI_WECB
#define NETLINK_USER 27 /* WiFi event, WPS button and LED control*/
#define AEI_NETLINK_MESSAGE 28 /* Link down up event and Reset button */

#define AEI_NET_PORT_LINK_DOWN 0x1000
#define AEI_NETLINK_RESET_BUTTON 0x2000

#define AEI_BUTTON_PRESS 1
#define AEI_BUTTON_RELEASE 0

#ifdef CONFIG_BR_IP_MAC_MAPPING
#define NETLINK_BR_IP_MAC_MAPPING   29 /*for mynetwork module */
#endif
