...
hsocket_open(hsocket_t * dsock, const char *hostname, int port, int ssl)
{
  ...
  /* CID 32042: Uninitialized scalar variable(UNINIT): 
     Using uninitialized value "address": field "address"."sin_zero" is uninitialized when calling "connect(int, struct sockaddr const *, socklen_t
  */
