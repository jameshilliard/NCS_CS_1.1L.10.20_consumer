...
#define PING_NO_ERROR    0
#define PING_HOST_ERROR    1
#define PING_PORT_ERROR    2
...
len_and_sockaddr* xhost_and_af2sockaddr_ext(const char *host, int port, sa_family_t af,int *error_type) FAST_FUNC RETURNS_MALLOC;
#endif
