...
#if defined (CONFIG_AEI_GETTY_LOGIN_ARGS)
#define _getty_login_args_full_usage \
     "\n	-a LOGINARGS	Pass LOGINARGS to login program"
#else
#define _getty_login_args_full_usage ""
#endif
...
#if defined (CONFIG_FEATURE_AEI_LOGIN_RULES_LIST)
#define _login_rules_list_trivial_usage \
       " [-r LOGIN_RULE_FILE]"
#define _login_rules_list_full_usage \
     "\n	-r	Specify login rule list file"
#else
#define _login_rules_list_trivial_usage ""
#define _login_rules_list_full_usage ""
#endif
#define login_trivial_usage \
       "[-p] [-h HOST] [[-f] USER]" \
       _login_rules_list_trivial_usage
