...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_WPAKEY,
                            0,
                            (char *) WPAKey,
                            65,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_WPS_AP_PIN,
                            0,
                            (char *) WpsApPin,
                            9,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_ADMIN_PASSWORD,
                            0,
                            (char *) Password,
                            33,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_CONSOLE_ACCESS,
                            0,
                            (char *) ConsoleAccess,
                            4,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_BURN_IN_TEST,
                            0,
                            (char *) BurnInTest,
                            2,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_MANU_MODE,
                            0,
                            (char *) ManuMode,
                            2,
                            0,
...
{
   unsigned char ptr[sizeof(NVRAM_AEI_WPA_KEY_TAG) + 64] = {0};
   memcpy(ptr,NVRAM_AEI_WPA_KEY_TAG,sizeof(NVRAM_AEI_WPA_KEY_TAG));
   memcpy(ptr+sizeof(NVRAM_AEI_WPA_KEY_TAG),WPAKey,64);

   return(devCtl_boardIoctl(BOARD_IOCTL_FLASH_WRITE,
                            NVRAM,
                            ptr,
                            sizeof(NVRAM_AEI_WPA_KEY_TAG)+64,
                            0, 0));
}

CmsRet setWPSApPin(UINT8 *Wpspin)
{
   unsigned char ptr[sizeof(NVRAM_AEI_WPS_AP_PIN_TAG) + 8] = {0};
   memcpy(ptr,NVRAM_AEI_WPS_AP_PIN_TAG,sizeof(NVRAM_AEI_WPS_AP_PIN_TAG));
   memcpy(ptr+sizeof(NVRAM_AEI_WPS_AP_PIN_TAG),Wpspin,8);

   return(devCtl_boardIoctl(BOARD_IOCTL_FLASH_WRITE,
                            NVRAM,
                            ptr,
                            sizeof(NVRAM_AEI_WPS_AP_PIN_TAG)+8,
                            0, 0));
}

CmsRet setAdminPassword(UINT8 *password)
{
   unsigned char ptr[sizeof(NVRAM_AEI_ADMIN_PASSWORD_TAG) + 32] = {0};
...
{
#define CONSOLE_ACCESS_FLAG_LENTH    10
   unsigned char ptr[sizeof(NVRAM_AEI_CONSOLE_ACCESS_TAG) + CONSOLE_ACCESS_FLAG_LENTH+1] = {0};
   memcpy(ptr, NVRAM_AEI_CONSOLE_ACCESS_TAG, sizeof(NVRAM_AEI_CONSOLE_ACCESS_TAG));
   snprintf(ptr+sizeof(NVRAM_AEI_CONSOLE_ACCESS_TAG),CONSOLE_ACCESS_FLAG_LENTH+1,"0x%X",*ConsoleAccess);
   return(devCtl_boardIoctl(BOARD_IOCTL_FLASH_WRITE,
                            NVRAM,
                            ptr,
                            sizeof(ptr),
...
{
   unsigned char ptr[sizeof(NVRAM_AEI_SN_TAG) + 32] = {0};
...
{
   unsigned char ptr[sizeof(NVRAM_AEI_HW_VERSION_TAG) + 8] = {0};
   memcpy(ptr,NVRAM_AEI_HW_VERSION_TAG,sizeof(NVRAM_AEI_HW_VERSION_TAG));
   memcpy(ptr+sizeof(NVRAM_AEI_HW_VERSION_TAG),HwVersion,8);

   return(devCtl_boardIoctl(BOARD_IOCTL_FLASH_WRITE,
                            NVRAM,
                            ptr,
                            sizeof(NVRAM_AEI_HW_VERSION_TAG)+8,
                            0, 0));
}
CmsRet SetBaseMacAddress(UINT8 *macaddress)
{
   unsigned char ptr[sizeof(NVRAM_AEI_BASE_MAC_ADDRESS_TAG) + MAC_ADDR_LEN] = {0};
...
{
   unsigned char ptr[sizeof(NVRAM_AEI_NUMBER_MAC_ADDRESS_TAG) +4] = {0};
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_ENABLE_BACKUP_PSI,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_SYSTEM_LOG_SIZE,
                            0,
                            (char *) SystemLogSize,
                            4,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_AUXILLARY_FILE_SYSTEM_SIZE,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_MAIN_THREAD_NUMBER,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_NUMBER_MAC_ADDRESSES,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_WLANFEATURE,
                            0,
                            (char *) WLANFeature,
                            1,
                            0,
...
{
   return(devCtl_boardIoctl(BOARD_IOCTL_GET_CFE_CONSOLE_PASSWORD,
                            0,
                            (char *) CfeConsolePassword,
                            65,
                            0,
                            ""));
}
...
{
   unsigned char ptr[sizeof(NVRAM_AEI_CFE_CONSOLE_PASSWORD_TAG) + 64] = {0};
   memcpy(ptr,NVRAM_AEI_CFE_CONSOLE_PASSWORD_TAG,sizeof(NVRAM_AEI_CFE_CONSOLE_PASSWORD_TAG));
   memcpy(ptr+sizeof(NVRAM_AEI_CFE_CONSOLE_PASSWORD_TAG),CfeConsolePassword,64);

   return(devCtl_boardIoctl(BOARD_IOCTL_FLASH_WRITE,
                            NVRAM,
                            ptr,
                            sizeof(NVRAM_AEI_CFE_CONSOLE_PASSWORD_TAG)+64,
                            0, 0));
}
#endif
...
CmsRet getDualImageVersion(UINT8 *imageVersion, SINT32 partition)
{
    return(devCtl_boardIoctl(BOARD_IOCTL_GET_IMAGE_VERSION,
                            0,
                            (char *) imageVersion,
                            24,
                            partition,
