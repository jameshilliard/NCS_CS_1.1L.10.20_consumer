...
/*********************************************************************
 *  [FUNCTION NAME]:
 *      tsl_rv_t dal_sys_update(void)
 *
 *  [DESCRIPTION]:
 *      Upgrade image steps:
 *      1. Cp new image to g /mnt/ubifs/ and rename to uImage.
 *      2. Call sync to save to flash and reboot.
 *
 *  [return]:
       SUCCESS or FAILED
 ********************************************************************/
tsl_rv_t dal_sys_update(dal_ret_t *upgrade_info);


/********************************************************************
 *  [FUNCTION NAME]:
 *      tsl_rv_t dal_get_sys_update_progress(void)
 *
 *  [DESCRIPTION]:
 *      Get update progress.
 *
 *  [return]:
       SUCCESS or FAILED
 ********************************************************************/
tsl_rv_t dal_sys_get_update_progress(void);
