...
typedef struct st_DeviceInfoObject_obj {
	 ...
	 tsl_uint_t X_ACTIONTEC_COM_RebootNumber;
	 tsl_uint_t X_ACTIONTEC_COM_FactoryResetNumber;
	 tsl_char_t *X_ACTIONTEC_COM_FCC_ID;
}DeviceInfoObject;
...
typedef struct st_tr157MemoryStatusObject_obj {
	 tsl_uint_t total;
	 tsl_uint_t free;
}tr157MemoryStatusObject;
typedef tr157MemoryStatusObject _tr157MemoryStatusObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_tr157MemoryStatusObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.DeviceInfo.MemoryStatus
 *
 *	[PARAMETER]:
 *	        tsl_char_t *p_oid_name
 *	        _tr157MemoryStatusObject *p_cur_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_get_tr157MemoryStatusObject_value(tsl_char_t *p_oid_name, _tr157MemoryStatusObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_tr157MemoryStatusObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.DeviceInfo.MemoryStatus
 *
 ...
 *	        tsl_char_t *p_oid_name
 *	        _tr157MemoryStatusObject *p_cur_data
 *	        _tr157MemoryStatusObject *p_new_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_set_tr157MemoryStatusObject_value(tsl_char_t *p_oid_name, _tr157MemoryStatusObject *p_cur_data, _tr157MemoryStatusObject *p_new_data);


/*Device.DeviceInfo.ProcessStatus*/
typedef struct st_tr157ProcessStatusObject_obj {
	 tsl_uint_t CPUUsage;
	 tsl_uint_t processNumberOfEntries;
}tr157ProcessStatusObject;
typedef tr157ProcessStatusObject _tr157ProcessStatusObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_tr157ProcessStatusObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.DeviceInfo.ProcessStatus
 *
 *	[PARAMETER]:
 *	        tsl_char_t *p_oid_name
 *	        _tr157ProcessStatusObject *p_cur_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_get_tr157ProcessStatusObject_value(tsl_char_t *p_oid_name, _tr157ProcessStatusObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_tr157ProcessStatusObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.DeviceInfo.ProcessStatus
 *
 ...
 *	        tsl_char_t *p_oid_name
 *	        _tr157ProcessStatusObject *p_cur_data
 *	        _tr157ProcessStatusObject *p_new_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_set_tr157ProcessStatusObject_value(tsl_char_t *p_oid_name, _tr157ProcessStatusObject *p_cur_data, _tr157ProcessStatusObject *p_new_data);


/*Device.DeviceInfo.ProcessStatus.Process*/
typedef struct st_tr157ProcessObject_obj {
	 tsl_uint_t PID;
	 tsl_char_t *command;
	 tsl_uint_t size;
	 tsl_uint_t priority;
...
typedef tr157ProcessObject _tr157ProcessObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_tr157ProcessObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.DeviceInfo.ProcessStatus.Process
 *
 *	[PARAMETER]:
 *	        tsl_char_t *p_oid_name
 *	        _tr157ProcessObject *p_cur_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_get_tr157ProcessObject_value(tsl_char_t *p_oid_name, _tr157ProcessObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_tr157ProcessObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.DeviceInfo.ProcessStatus.Process
 *
 ...
 *	        tsl_char_t *p_oid_name
 *	        _tr157ProcessObject *p_cur_data
 *	        _tr157ProcessObject *p_new_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_set_tr157ProcessObject_value(tsl_char_t *p_oid_name, _tr157ProcessObject *p_cur_data, _tr157ProcessObject *p_new_data);
...
typedef struct st_ManagementServerObject_obj {
	 ...
	 tsl_uint_t UDPConnectionRequestAddressNotificationLimit;
...
typedef struct st_TimeServerCfgObject_obj {
	 ...
	 tsl_int_t X_ACTIONTEC_COM_DaylightSavingsUsed;
...
/*Device.UserInterface.X_ACTIONTEC_COM_ConsoleAccess*/
typedef struct st_ConsoleAcessObject_obj {
	 tsl_int_t enable;
}ConsoleAcessObject;
typedef ConsoleAcessObject _ConsoleAcessObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_ConsoleAcessObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.UserInterface.X_ACTIONTEC_COM_ConsoleAccess
 *
 *	[PARAMETER]:
 *	        tsl_char_t *p_oid_name
 *	        _ConsoleAcessObject *p_cur_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_get_ConsoleAcessObject_value(tsl_char_t *p_oid_name, _ConsoleAcessObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_ConsoleAcessObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.UserInterface.X_ACTIONTEC_COM_ConsoleAccess
 *
 ...
 *	        tsl_char_t *p_oid_name
 *	        _ConsoleAcessObject *p_cur_data
 *	        _ConsoleAcessObject *p_new_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_set_ConsoleAcessObject_value(tsl_char_t *p_oid_name, _ConsoleAcessObject *p_cur_data, _ConsoleAcessObject *p_new_data);
...
typedef struct st_MOCAInterfaceObject_obj {
	 ...
	 tsl_int_t X_ACTIONTEC_COM_Restart;
	 tsl_char_t *alias;
	 tsl_char_t *name;
	 tsl_uint_t lastChange;
	 tsl_uint_t X_ACTIONTEC_COM_LastChangeTime;
	 tsl_int_t X_ACTIONTEC_COM_TPCEnable;
	 tsl_char_t *lowerLayers;
	 tsl_int_t upstream;
	 tsl_char_t *MACAddress;
	 ...
	 tsl_char_t *X_ACTIONTEC_COM_ActiveVersion;
	 ...
	 tsl_char_t *X_ACTIONTEC_COM_NetworkTabooStartFreq;
	 tsl_char_t *networkTabooMask;
	 ...
	 tsl_uint_t X_ACTIONTEC_COM_ActiveNodes;
	 tsl_uint_t associatedDeviceNumberOfEntries;
	 tsl_char_t *X_ACTIONTEC_COM_ModulationTxUnicast;
	 tsl_char_t *X_ACTIONTEC_COM_ModulationRxUnicast;
	 tsl_char_t *X_ACTIONTEC_COM_ModulationTxBroadcastVLPER;
	 tsl_char_t *X_ACTIONTEC_COM_ModulationTxBroadcastNPER;
	 tsl_char_t *X_ACTIONTEC_COM_ModulationRxBroadcast;
	 tsl_uint_t X_ACTIONTEC_COM_RxUnicastPowerLevel;
	 tsl_uint_t X_ACTIONTEC_COM_RxBroadcastPowerLevel;
	 tsl_uint_t X_ACTIONTEC_COM_TxUnicastPowerControlReduction;
	 tsl_uint_t X_ACTIONTEC_COM_TxBroadcastVLPERPowerControlReduction;
	 tsl_uint_t X_ACTIONTEC_COM_TxBroadcastNPERPowerControlReduction;
}MOCAInterfaceObject;
...
typedef struct st_MOCAInterfaceStatObject_obj {
	 ...
	 tsl_uint_t broadcastPacketsReceived;
	 tsl_uint_t unknownProtoPacketsReceived;
	 tsl_uint_t X_ACTIONTEC_COM_MissedOrCrcErrorPkts;
	 tsl_uint_t X_ACTIONTEC_COM_CorrectedReedSolomonBytes;
...
typedef struct st_WIFIRadioObject_obj {
	 ...
	 tsl_int_t X_ACTIONTEC_COM_AutoChannelBootOnly;
	 ...
	 tsl_int_t X_ACTIONTEC_COM_Coexistance;
	 tsl_int_t X_ACTIONTEC_COM_DFSEnabled;
	 tsl_int_t X_ACTIONTEC_COM_RadioReload;
}WIFIRadioObject;
...
typedef struct st_WIFISSIDObject_obj {
	 ...
	 tsl_char_t *SSID;
	 tsl_uint_t X_EXPOSE;
	 tsl_int_t X_ACTIONTEC_COM_SSIDReload;
}WIFISSIDObject;
...
typedef struct st_WIFIAccessPointObject_obj {
	 ...
	 tsl_int_t isolationEnable;
	 tsl_uint_t X_ACTIONTEC_COM_BeaconInterval;
	 tsl_int_t X_ACTIONTEC_COM_MSDU;
...
typedef struct st_WIFIAccessPointWpsObject_obj {
	 ...
	 tsl_uint_t X_PIN_TYPE;
	 tsl_uint_t X_AP_PIN;
	 tsl_uint_t X_STATION_PIN;
	 tsl_uint_t X_State;
	 tsl_int_t X_Configured;
	 tsl_uint_t X_TimesSuccess;
	 tsl_uint_t X_TimesFailures;
	 tsl_uint_t X_TimesAttempts;
...
typedef struct st_WIFIAccessPointAssociatedDeviceObject_obj {
	 ...
	 tsl_char_t *X_COMCAST_COM_ConnectionStandard;
	 tsl_uint_t X_COMCAST_COM_LinkTime;
...
/*Device.WiFi.AccessPoint.0.WMM*/
typedef struct st_WIFIAccessPointWmmObject_obj {
	 tsl_uint_t X_ACTIONTEC_COM_WMM_AIFSN;
	 tsl_uint_t X_ACTIONTEC_COM_WMM_ECWMin;
	 tsl_uint_t X_ACTIONTEC_COM_WMM_ECWMax;
	 tsl_uint_t X_ACTIONTEC_COM_WMM_TXOP;
	 tsl_int_t X_ACTIONTEC_COM_WMM_AckPolicy;
}WIFIAccessPointWmmObject;
typedef WIFIAccessPointWmmObject _WIFIAccessPointWmmObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_WIFIAccessPointWmmObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.WiFi.AccessPoint.i.WMM
 *
 *	[PARAMETER]:
 *	        tsl_char_t *p_oid_name
 *	        _WIFIAccessPointWmmObject *p_cur_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_get_WIFIAccessPointWmmObject_value(tsl_char_t *p_oid_name, _WIFIAccessPointWmmObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_WIFIAccessPointWmmObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.WiFi.AccessPoint.i.WMM
 *
 ...
 *	        tsl_char_t *p_oid_name
 *	        _WIFIAccessPointWmmObject *p_cur_data
 *	        _WIFIAccessPointWmmObject *p_new_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_set_WIFIAccessPointWmmObject_value(tsl_char_t *p_oid_name, _WIFIAccessPointWmmObject *p_cur_data, _WIFIAccessPointWmmObject *p_new_data);
...
typedef struct st_IP_IPDiagnosticsObject_obj {
}IP_IPDiagnosticsObject;
typedef IP_IPDiagnosticsObject _IP_IPDiagnosticsObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_IP_IPDiagnosticsObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.IP.Diagnostics
 *
 *	[PARAMETER]:
 *	        tsl_char_t *p_oid_name
 *	        _IP_IPDiagnosticsObject *p_cur_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_get_IP_IPDiagnosticsObject_value(tsl_char_t *p_oid_name, _IP_IPDiagnosticsObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_IP_IPDiagnosticsObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.IP.Diagnostics
 *
 ...
 *	        tsl_char_t *p_oid_name
 *	        _IP_IPDiagnosticsObject *p_cur_data
 *	        _IP_IPDiagnosticsObject *p_new_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_set_IP_IPDiagnosticsObject_value(tsl_char_t *p_oid_name, _IP_IPDiagnosticsObject *p_cur_data, _IP_IPDiagnosticsObject *p_new_data);


/*Device.IP.Diagnostics.IPPing*/
typedef struct st_IPPingDiagObject_obj {
	 tsl_char_t *diagnosticsState;
	 ...
	 tsl_uint_t minimumResponseTime;
	 tsl_uint_t maximumResponseTime;
	 tsl_int_t X_181BEB_RequestFromTR069;
}IPPingDiagObject;
...
/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_IPPingDiagObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.IP.Diagnostics.IPPing
 *
...
tsl_int_t tr69_func_get_IPPingDiagObject_value(tsl_char_t *p_oid_name, _IPPingDiagObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_IPPingDiagObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.IP.Diagnostics.IPPing
 *
...
tsl_int_t tr69_func_set_IPPingDiagObject_value(tsl_char_t *p_oid_name, _IPPingDiagObject *p_cur_data, _IPPingDiagObject *p_new_data);


/*Device.IP.Diagnostics.TraceRoute*/
typedef struct st_TraceRouteDiagnosticsObject_obj {
	 tsl_uint_t X_181BEB_Pid;
	 tsl_char_t *diagnosticsState;
	 tsl_char_t *interface;
	 tsl_char_t *host;
	 tsl_uint_t numberOfTries;
	 tsl_uint_t dataBlockSize;
	 tsl_uint_t DSCP;
	 tsl_uint_t maxHopCount;
	 tsl_uint_t timeout;
	 tsl_uint_t responseTime;
	 tsl_uint_t routeHopsNumberOfEntries;
	 tsl_uint_t X_181BEB_timerID;
...
/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_TraceRouteDiagnosticsObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.IP.Diagnostics.TraceRoute
 *
 *	[PARAMETER]:
 *	        tsl_char_t *p_oid_name
 *	        _TraceRouteDiagnosticsObject *p_cur_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_get_TraceRouteDiagnosticsObject_value(tsl_char_t *p_oid_name, _TraceRouteDiagnosticsObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_TraceRouteDiagnosticsObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.IP.Diagnostics.TraceRoute
 *
 ...
 *	        tsl_char_t *p_oid_name
 *	        _TraceRouteDiagnosticsObject *p_cur_data
 *	        _TraceRouteDiagnosticsObject *p_new_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_set_TraceRouteDiagnosticsObject_value(tsl_char_t *p_oid_name, _TraceRouteDiagnosticsObject *p_cur_data, _TraceRouteDiagnosticsObject *p_new_data);


/*Device.IP.Diagnostics.TraceRoute.RouteHops*/
typedef struct st_TraceRouteDiagRouteHopsObject_obj {
	 tsl_char_t *hopHost;
	 tsl_char_t *hopHostAddress;
	 tsl_uint_t hopErrorCode;
	 tsl_char_t *hopRTTimes;
}TraceRouteDiagRouteHopsObject;
typedef TraceRouteDiagRouteHopsObject _TraceRouteDiagRouteHopsObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_TraceRouteDiagRouteHopsObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.IP.Diagnostics.TraceRoute.RouteHops
 *
 *	[PARAMETER]:
 *	        tsl_char_t *p_oid_name
 *	        _TraceRouteDiagRouteHopsObject *p_cur_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_get_TraceRouteDiagRouteHopsObject_value(tsl_char_t *p_oid_name, _TraceRouteDiagRouteHopsObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_TraceRouteDiagRouteHopsObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.IP.Diagnostics.TraceRoute.RouteHops
 *
 ...
 *	        tsl_char_t *p_oid_name
 *	        _TraceRouteDiagRouteHopsObject *p_cur_data
 *	        _TraceRouteDiagRouteHopsObject *p_new_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_set_TraceRouteDiagRouteHopsObject_value(tsl_char_t *p_oid_name, _TraceRouteDiagRouteHopsObject *p_cur_data, _TraceRouteDiagRouteHopsObject *p_new_data);
...
typedef struct st_Dhcpv4ClientObject_obj {
	 ...
	 tsl_int_t X_ACTIONTEC_COM_WanPort;
	 tsl_uint_t sentOptionNumberOfEntries;
}Dhcpv4ClientObject;
...
/*Device.DHCPv4.Client.0.SentOption*/
typedef struct st_Dhcpv4ClientSentOptionObject_obj {
	 tsl_int_t enable;
	 tsl_char_t *alias;
	 tsl_uint_t tag;
	 tsl_char_t *value;
	 tsl_char_t *X_ACTIONTEC_COM_ASCIIValue;
}Dhcpv4ClientSentOptionObject;
typedef Dhcpv4ClientSentOptionObject _Dhcpv4ClientSentOptionObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_Dhcpv4ClientSentOptionObject_value
 *
 *	[DESCRIPTION]:
 ...
 *	[PARAMETER]:
 *	        tsl_char_t *p_oid_name
 *	        _Dhcpv4ClientSentOptionObject *p_cur_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_get_Dhcpv4ClientSentOptionObject_value(tsl_char_t *p_oid_name, _Dhcpv4ClientSentOptionObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_Dhcpv4ClientSentOptionObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.DHCPv4.Client.i.SentOption
 *
 ...
 *	        tsl_char_t *p_oid_name
 *	        _Dhcpv4ClientSentOptionObject *p_cur_data
 *	        _Dhcpv4ClientSentOptionObject *p_new_data
 *
 *	[RETURN]
 *              >= 0          SUCCESS
 *              <  0          ERROR
...
tsl_int_t tr69_func_set_Dhcpv4ClientSentOptionObject_value(tsl_char_t *p_oid_name, _Dhcpv4ClientSentOptionObject *p_cur_data, _Dhcpv4ClientSentOptionObject *p_new_data);
...
typedef struct st_UsersUserObject_obj {
	 ...
	 tsl_char_t *password;
	 tsl_char_t *language;
	 tsl_char_t *X_ACTIONTEC_COM_UserAccessSrcGrant;
...
/*Device.X_ACTIONTEC_COM_SYSLOG*/
typedef struct st_SyslogObject_obj {
	 tsl_int_t enable;
	 tsl_int_t enableLogToRemote;
	 tsl_char_t *serverIP;
}SyslogObject;
typedef SyslogObject _SyslogObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_SyslogObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.X_ACTIONTEC_COM_SYSLOG
 *
...
tsl_int_t tr69_func_get_SyslogObject_value(tsl_char_t *p_oid_name, _SyslogObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_SyslogObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.X_ACTIONTEC_COM_SYSLOG
 *
...
tsl_int_t tr69_func_set_SyslogObject_value(tsl_char_t *p_oid_name, _SyslogObject *p_cur_data, _SyslogObject *p_new_data);


/*Device.X_ACTIONTEC_COM_GRE*/
typedef struct st_GreObject_obj {
	 tsl_uint_t tunnelNumberOfEntries;
}GreObject;
...
tsl_int_t tr69_func_get_GreObject_value(tsl_char_t *p_oid_name, _GreObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_GreObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.X_ACTIONTEC_COM_GRE
 *
...
tsl_int_t tr69_func_set_GreObject_value(tsl_char_t *p_oid_name, _GreObject *p_cur_data, _GreObject *p_new_data);


/*Device.X_ACTIONTEC_COM_GRE.Tunnel*/
typedef struct st_GreTunnelObject_obj {
	 ...
	 tsl_uint_t X_ACTIONTEC_COM_LastChangeTime;
	 tsl_char_t *lowerLayers;
	 tsl_char_t *remoteIPv4Address;
	 tsl_char_t *localIPv4Address;
	 tsl_char_t *addressSource;
	 tsl_char_t *tunnelInterface;
	 tsl_char_t *tunneledInterface;
}GreTunnelObject;
...
/*Device.X_ACTIONTEC_COM_HNAP*/
typedef struct st_HnapObject_obj {
}HnapObject;
typedef HnapObject _HnapObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_HnapObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.X_ACTIONTEC_COM_HNAP
 *
...
tsl_int_t tr69_func_get_HnapObject_value(tsl_char_t *p_oid_name, _HnapObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_HnapObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.X_ACTIONTEC_COM_HNAP
 *
...
tsl_int_t tr69_func_set_HnapObject_value(tsl_char_t *p_oid_name, _HnapObject *p_cur_data, _HnapObject *p_new_data);


/*Device.X_ACTIONTEC_COM_HNAP.Server*/
typedef struct st_HnapServerObject_obj {
	 tsl_int_t enable;
	 tsl_char_t *interface;
	 tsl_int_t X_ACTIONTEC_COM_Trigger;
	 tsl_char_t *SSDPStatus;
	 tsl_char_t *syncStatus;
	 tsl_char_t *specVersion;
	 tsl_char_t *deviceType;
	 tsl_uint_t SSDPPort;
	 tsl_uint_t SSDPPeriod;
	 tsl_uint_t locationPort;
	 tsl_char_t *UUID;
	 tsl_uint_t maxAge;
	 tsl_int_t SSL;
	 tsl_char_t *protocol;
	 tsl_char_t *URN;
	 tsl_char_t *protocol2;
	 tsl_char_t *URN2;
	 tsl_int_t AUTH_Enable;
	 tsl_char_t *username;
	 tsl_char_t *password;
	 tsl_char_t *logLevel;
	 tsl_char_t *forceResGetDeviceSettings;
	 tsl_char_t *forceResGetWlanRadios;
	 tsl_char_t *forceResGetExtenderStatus;
	 tsl_char_t *forceResSetWPS;
	 tsl_char_t *forceResSetRadios;
	 tsl_char_t *forceResSetSSIDSettings;
	 tsl_char_t *forceResSetDoRestart;
	 tsl_char_t *forceResIsDeviceReady;
	 tsl_char_t *forceResSetTOD;
	 tsl_char_t *forceResGetClientInfo;
	 tsl_int_t logFile_Enable;
	 tsl_int_t logFile_Clean;
	 tsl_int_t logFile_Full;
	 tsl_uint_t logFile_Maxsize;
	 tsl_char_t *logFile_Level;
	 tsl_int_t syncWiFiChannel;
}HnapServerObject;
typedef HnapServerObject _HnapServerObject;


/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_get_HnapServerObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.X_ACTIONTEC_COM_HNAP.Server
 *
...
tsl_int_t tr69_func_get_HnapServerObject_value(tsl_char_t *p_oid_name, _HnapServerObject *p_cur_data);

/**************************************************************************
 *	[FUNCTION NAME]:
 *	        tf69_func_set_HnapServerObject_value
 *
 *	[DESCRIPTION]:
 *	        Device.X_ACTIONTEC_COM_HNAP.Server
 *
...
tsl_int_t tr69_func_set_HnapServerObject_value(tsl_char_t *p_oid_name, _HnapServerObject *p_cur_data, _HnapServerObject *p_new_data);
...
typedef VzIgmpQueryObject _VzIgmpQueryObject;
...
typedef struct st_XMPPConnServerObject_obj {
	 ...
	 tsl_uint_t port;
}XMPPConnServerObject;
typedef XMPPConnServerObject _XMPPConnServerObject;
