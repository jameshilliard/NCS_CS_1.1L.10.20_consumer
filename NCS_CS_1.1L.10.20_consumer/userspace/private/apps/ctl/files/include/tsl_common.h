...
#if 1
    CTL_CMSRET_METHOD_NOT_SUPPORTED = 9000,  /**<Method not supported. */
    CTL_CMSRET_REQUEST_DENIED       = 9001,  /**< Request denied (no reason specified). */
    CTL_CMSRET_INTERNAL_ERROR       = 9002,  /**< Internal error. */
    CTL_CMSRET_INVALID_ARGUMENTS    = 9003,  /**< Invalid arguments. */
    CTL_CMSRET_RESOURCE_EXCEEDED    = 9004,  /**< Resource exceeded.  */
    CTL_CMSRET_INVALID_PARAM_NAME   = 9005,  /**< Invalid pARAM_TYPE   = 9006,
                                          *  (associated with set/getParameterValues)
                                          *                                          */
    CTL_CMSRET_INVALID_PARAM_VALUE  = 9007,  /**< Invalid parameter value.
                                          *  (associated with set/getParameterValues)
                                          *                                          */
    CTL_CMSRET_SET_NON_WRITABLE_PARAM = 9008,/**< Attempt to set a non-writable parameter.
                                          *  (associated with setParameterValues)
                                          *                                          */
    CTL_CMSRET_NOTIFICATION_REQ_REJECTED = 9009, /**< Notification request rejected.
                                               +------------  2 lines: *  (associated with setParameterAttributes)-----------------------*/

    CTL_CMSRET_DOWNLOAD_FAILURE     = 9010,  /**< Download failure.
                                          *  (associated with download or transferComplete)
                                          *                                           */
    CTL_CMSRET_UPLOAD_FAILURE       = 9011,  /**< Upload failure.
                                          *  (associated with upload or transferComplete)
                                          */
    CTL_CMSRET_FILE_TRANSFER_AUTH_FAILURE = 9012,  /**< File transfer server authentication*/
    CTL_CMSRET_UNSUPPORTED_FILE_TRANSFER_PROTOCOL = 9013,/**< Unsupported protocol for file transfer */
    CTL_CMSRET_FILE_TRANSFER_NOT_ACCESS_FILESERVER = 9015, /* File transfer failure: unable to contact file server */
    CTL_CMSRET_FILE_TRANSFER_INVALID_FILENAME = 9016,   /* File Server Authorization failed */
    CTL_CMSRET_FILE_TRANSFER_NOT_COMPLETE = 9017, /* File transfer failure: unable to complete download */
    CTL_CMSRET_FILE_UNUSABLE_CORRUPTED = 9018,  /* File transfer failure: file corrupted or otherwise unusable */
    CTL_CMSRET_DUPLICATE_INSTANCE_EXIST	= 9101,

    CTL_CMSRET_SUCCESS_REBOOT_REQUIRED = 9800, /**< Config successful, but requires reboot to take effect. */
    CTL_CMSRET_SUCCESS_UNRECOGNIZED_DATA_IGNORED = 9801,  /**<Success, but some unrecognized data was ignored. */
    CTL_CMSRET_SUCCESS_OBJECT_UNCHANGED = 9802,  /**<Success, furthermore object has not changed, returned by STL handl
                                               er functions. */
    CTL_CMSRET_FAIL_REBOOT_REQUIRED = 9803,  /**<Config failed, and now system is in a bad state requiring reboot. */
    CTL_CMSRET_NO_MORE_INSTANCES = 9804,     /**<getnext operation cannot find any more instances to return. */
    CTL_CMSRET_MDM_TREE_ERROR = 9805,         /**<Error during MDM tree traversal */
    CTL_CMSRET_WOULD_DEADLOCK = 9806, /**< Caller is requesting a lock while holding the same lock or a different one.
    */
    CTL_CMSRET_LOCK_REQUIRED = 9807,  /**< The MDM lock is required for this operation. */
    CTL_CMSRET_OP_INTR = 9808,      /**<Operation was interrupted, most likely by a Linux signal. */
    CTL_CMSRET_TIMED_OUT = 9809,     /**<Operation timed out. */
    CTL_CMSRET_DISCONNECTED = 9810,  /**< Communications link is disconnected. */
    CTL_CMSRET_MSG_BOUNCED = 9811,   /**< Msg was sent to a process not running, and the
                                  *   bounceIfNotRunning flag was set on the header.  */
    CTL_CMSRET_OP_ABORTED_BY_USER = 9812,  /**< Operation was aborted/discontinued by the user */
    CTL_CMSRET_RECURSION_ERROR = 9817,     /**< too many levels of recursion */
    CTL_CMSRET_OPEN_FILE_ERROR = 9818,     /**< open file error */
    CTL_CMSRET_KEY_GENERATION_ERROR = 9830,     /** certificate key generation error */
    CTL_CMSRET_INVALID_CERT_REQ = 9831,     /** requested certificate does not match with issued certificate */
    CTL_CMSRET_INVALID_CERT_SUBJECT = 9832,     /** certificate has invalid subject information */
    CTL_CMSRET_OBJECT_NOT_FOUND = 9840,     /** failed to find object */

    CTL_CMSRET_INVALID_FILENAME = 9850,  /**< filename was not given for download */
    CTL_CMSRET_INVALID_IMAGE = 9851,     /**< bad image was given for download */
    CTL_CMSRET_INVALID_CONFIG_FILE = 9852,  /**< invalid config file was detected */
    CTL_CMSRET_CONFIG_PSI = 9853,         /**< old PSI/3.x config file was detected */
    CTL_CMSRET_IMAGE_FLASH_FAILED = 9854, /**< could not write the image to flash */
#endif

#ifdef ACTION_TEC
    CTL_CMSRET_MESSAGE_NOEXIST = 9900, /**< Requestesd message entry does not exist*/
#endif
    /***********************************************************
     *
     *              Define Common Macro
