...
#define SOFTWARE_VERSION "1.1.10.20"
...
#define PING_FROM_OTHER    0  //ping
#define PING_FROM_LOCAL   1   // web ping 
#define PING_FROM_TR69     2   // tr69 ping
...
do { \
        ...
        system("rm -f /mnt/rt_conf/tr69_*");\
        system("rm -f "ZIP_CFG_FULLPATH); \
        system("rm -f /mnt/rt_conf/firstuse");\
        system("sync"); \
} while(0)
#else
