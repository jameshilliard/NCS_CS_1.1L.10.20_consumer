...
#else
            extsw_rreg_wrap(((e->offset & 0xFF00)>>8), (e->offset & 0xFF), data,
                              e->length == 8? e->length |SWAP_TYPE1: e->length);
#endif
        }
#endif /* EXT_SWITCH */		
        else
...
#else
            extsw_wreg_wrap(((e->offset & 0xFF00)>>8), (e->offset & 0xFF), e->data, e->length);
#endif
        }
        else
#endif /* EXT_SWITCH */		
