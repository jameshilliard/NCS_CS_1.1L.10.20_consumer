...
#define BCM_PHYID_M      0xFFF0
    ...
    #define REG_PORT_STATE                                0x58
        ...
        #define REG_PORT2_STATE                                  0x5D /*For Qunatenna port in 63268 chip*/
#endif
...
#if defined(CONFIG_AEI_QUANTENNA_RGMII)
#define LAN_PORT_ID_2   2 // Port2 for Quantenna
#define AEI_QTN_RGMII_PORT_IDX 7 // index of RoboSW GMac port which connect to Quantenna
#endif
