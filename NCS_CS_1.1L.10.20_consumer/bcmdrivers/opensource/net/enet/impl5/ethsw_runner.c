...
PHY_STAT ethsw_phy_stat(int port) /* FIXME  - duplicate code; Merge together with ethsw_dma.c */
{
    int phyId;
...
PHY_STAT ethsw_phy_stat(int port) /* FIXME  - very similar code/functionality; Merge together with the above */
{
    PHY_STAT phys;
