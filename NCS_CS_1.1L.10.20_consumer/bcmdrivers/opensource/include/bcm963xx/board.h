...
#define BOARD_IOCTL_GET_HW_VERSION        _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 2,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_WPAKEY            _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 3,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_WPS_AP_PIN        _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 4,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_ADMIN_PASSWORD    _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 5,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_CONSOLE_ACCESS    _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 6,  BOARD_IOCTL_PARMS)
#ifdef AEI_FACTORY_TEST
#define BOARD_IOCTL_GET_BURN_IN_TEST      _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 7,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_MANU_MODE         _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 8,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_ENABLE_BACKUP_PSI            _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 9,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_SYSTEM_LOG_SIZE              _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 10,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_AUXILLARY_FILE_SYSTEM_SIZE   _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 11,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_MAIN_THREAD_NUMBER           _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 12,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_NUMBER_MAC_ADDRESSES         _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 13,  BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_WLANFEATURE                  _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 14,  BOARD_IOCTL_PARMS)

#ifdef AEI_CONSOLE_PASSWD_IN_NVRAM
#define BOARD_IOCTL_GET_CFE_CONSOLE_PASSWORD         _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 15,  BOARD_IOCTL_PARMS)
#endif

#else
#ifdef AEI_CONSOLE_PASSWD_IN_NVRAM

#define BOARD_IOCTL_GET_CFE_CONSOLE_PASSWORD         _IOWR(BOARD_IOCTL_MAGIC, BASE_AEI_IOCPRIVATE + 7,  BOARD_IOCTL_PARMS)
#endif
...
#define NVRAM_AEI_CONSOLE_ACCESS_TAG "aei_console_access"
...
#endif
#ifdef AEI_CONSOLE_PASSWD_IN_NVRAM
#define NVRAM_AEI_CFE_CONSOLE_PASSWORD_TAG "aei_cfe_console_password"
#endif
#endif

#if defined(AEI_DUAL_IMAGE)
#define BASE_IOCTL_DUAL_IAMGE 80
#define BOARD_IOCTL_GET_IMAGE_VERSION             _IOWR(BOARD_IOCTL_MAGIC, BASE_IOCTL_DUAL_IAMGE + 1,  BOARD_IOCTL_PARMS)
#endif
#endif
...
typedef enum
{
    ...
    kLedStateAllOn,                      /* turn all led on */
    kLedStateAllBlink                    /* turn all led on */
#else
    kLedStateUserWpsSessionOverLap       /* 100ms on, 100ms off, 5 times, off for 500ms */                     
#endif
} BOARD_LED_STATE;
...
extern int kerSysBcmNandImageSet( char *rootfs_part, char *string, int img_size,
    int should_yield, int partition);
#else
extern int kerSysBcmNandImageSet( char *rootfs_part, char *string, int img_size,
    int should_yield );
#endif
