...
#WLAN Module
 test -e /lib/modules/$KERNELVER/kernel/drivers/net/wireless/quantenna/qdpc-host.ko && echo /sbin/hotplug-script > /proc/sys/kernel/hotplug && insmod /lib/modules/$KERNELVER/kernel/drivers/net/wireless/quantenna/qdpc-host.ko
