...
enum bp_id {
  ...
  /* Actiontec code begin */
  bp_usGpioLedUsb,            /* GPIO pin or not defined */
  bp_usGpioLedSesWirelessFail,
  bp_usGpioLedWirelessRed,
  bp_usGpioLedWireless2GAct,
  bp_usGpioLedWireless2G,
  bp_usGpioLedWireless2GFail,
  bp_usGpioLedWireless5GFail,
  bp_usGpioLedEnetWan,
  bp_usGpioLEDPhy1Fail,
  bp_usGpioLEDPhy2Fail,
  /* Actiontec code end*/
  bp_usGpioLedEpon,
