...
#ifdef AEI_WECB
int BpGetWirelessSesLedGpio2( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedSesWirelessFail, pusValue ) );
} /* BpGetWirelessSesLedGpio */
int BpGetWireless2GLedGpioACT( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedWireless2GAct, pusValue ) );
}
int BpGetWireless2GLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedWireless2G, pusValue ) );
}
int BpGetWireless2GFailLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedWireless2GFail, pusValue ) );
}
int BpGetWireless5GFailLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLedWireless5GFail, pusValue ) );
}
int BpGetGpioLEDPhy1Fail( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLEDPhy1Fail, pusValue ) );
}
int BpGetGpioLEDPhy2Fail( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioLEDPhy2Fail, pusValue ) );
}
#endif
#if !defined(_CFE_)
/**************************************************************************
...
int BpGetAllPinmux(int maxnum, int *outcnt, int *errcnt, unsigned short *pusFunction, unsigned long *pulMuxInfo)
{
    ...
    cp = (void *)Enet;
    for (i = 0 ; i < BP_MAX_ENET_MACS * sizeof(ETHERNET_MAC_INFO) ; i++) {
        cp[i] = 0;
    }
    *outcnt = 0;
    *errcnt = 0;
