...
#define DEFAULT_BOOTLINE    "e=192.168.1.1:ffffff00 h=192.168.1.100 g=192.168.1.254 r=f f=vmlinux i=bcm963xx_fs_kernel d=1 p=0 c= a= "
...
#endif
#ifdef AEI_WECB
#define DEFAULE_CONSOLE_ACCESS 0x0
#endif
...
#define NVRAM_IMAGEVERSION_LEN 24
#endif 
...
typedef struct
{
    ...
    unsigned int ulConsoleAccess;
#ifdef AEI_CONSOLE_PASSWD_IN_NVRAM
    char cfeConsolePassword1[27+65-33-4-2-2]; // size 51
#else
    char AeiUnused[27+65-33-4-2-2];
#endif
#ifdef AEI_FACTORY_TEST
    char BurnInTest[2];
    char ManuMode[2];
#else
    char AeiUnused_1[2+2];
#endif
    char WpsAPPin[9];
    
#if defined(AEI_DUAL_IMAGE)
    char ImageVersion1[NVRAM_IMAGEVERSION_LEN];  //previous image version
    char ImageVersion2[NVRAM_IMAGEVERSION_LEN];  //new image version
#endif
#ifdef AEI_CONSOLE_PASSWD_IN_NVRAM
    char cfeConsolePassword2[15]; // size 15
#endif
#endif
...
#if defined(AEI_DUAL_IMAGE)
#ifdef AEI_CONSOLE_PASSWD_IN_NVRAM
    char chUnused[284 - 33 - 9 - 27 - 65 - 65 - 9 -15 - NVRAM_IMAGEVERSION_LEN*2]; /* Adjust chUnused such that everything above + chUnused[] + ulCheckSum = 1k */
#else
    char chUnused[284 - 33 - 9 - 27 - 65 - 65 - 9 - NVRAM_IMAGEVERSION_LEN*2]; /* Adjust chUnused such that everything above + chUnused[] + ulCheckSum = 1k */
#endif
#else
#ifdef AEI_CONSOLE_PASSWD_IN_NVRAM
    char chUnused[284 - 33 - 9 - 27 - 65 - 65 - 9 - 15]; /* Adjust chUnused such that everything above + chUnused[] + ulCheckSum = 1k */
#else
    char chUnused[284 - 33 - 9 - 27 - 65 - 65 - 9]; /* Adjust chUnused such that everything above + chUnused[] + ulCheckSum = 1k */
#endif
#endif
#else
