...
#define BP_MAX_CROSSBAR_PORTS                   4
#define BP_MAX_PHY_PORTS                        (BP_CROSSBAR_PORT_BASE + BP_MAX_CROSSBAR_PORTS)
...
typedef struct {
  ...
  ETHERNET_CROSSBAR_INFO crossbar[BP_MAX_CROSSBAR_PORTS];
} ETHERNET_SW_INFO;
