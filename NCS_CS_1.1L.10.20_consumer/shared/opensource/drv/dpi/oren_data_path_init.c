...
static  ETHERNET_MAC_INFO 	pBoardInfo[BP_MAX_ENET_MACS];
...
{
    int bp_port_idx = 0;
    ETHERNET_SW_INFO *sw = &pBoardInfo[0].sw;
...
uint32_t oren_data_path_init( S_DPI_CFG  *pCfg)
{
    ...
    if ( BpGetEthernetMacInfo(pBoardInfo, BP_MAX_ENET_MACS) == BP_BOARD_ID_NOT_SET )
	{
